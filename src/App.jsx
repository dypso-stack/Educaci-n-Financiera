...
// ─── BANCO DE ESCENARIOS DE JUEGO (selección aleatoria por partida) ─────────
...
// Al iniciar cada partida, se seleccionan 4 escenarios al azar
...
function QuizMode({ xp, setXp, onBack, onGoGame, onGoLearn, onGoHome, onComplete, rewardEnabled = true, sidebarEl, GSTYLE }) {
  ...
  const questions = useMemo(() => shuffle(QUESTION_BANK).slice(0, 10), [attempt, QUESTION_BANK]);
    ...
    <>{GFONT}{GSTYLE}<div className="app-main" style={appSt}>
      ...
      <div style={{ padding: "18px 18px 88px" }}>
          ...
          <div style={{ position: "relative" }}>
            ...
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", gap: 12, marginBottom: 8 }}>
              ...
              <div style={{ fontSize: 12, opacity: 0.85 }}>
                {completedActivities === totalActivities ? "Ruta completada ✅" : `${Math.max(totalActivities - completedActivities, 0)} módulo${Math.max(totalActivities - completedActivities, 0) === 1 ? "" : "s"} por completar`}
              </div>
            </div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr", gap: 12, marginBottom: 16 }}>
          <button
            onClick={() => { if (allLessonsCompleted) setScreen("quizmode"); else resumeLearning(); }}
            style={{
              width: "100%",
              textAlign: "left",
              padding: 18,
          ...
          >
            ...
            <div style={{ fontSize: 13, color: C.textSoft, lineHeight: 1.55 }}>
              {allLessonsCompleted ? "Ruta de aprendizaje finalizada ✅" : lastLearning?.lessonId ? `Retoma en la página ${(lastLearning.pageIndex || 0) + 1}.` : "Sigue con el siguiente tema disponible a tu ritmo."}
            </div>
          </button>
            ...
            <div style={{ marginTop: 18 }}>
              <div style={{ background: `linear-gradient(160deg, ${C.secondary} 0%, ${C.primary} 100%)`, borderRadius: 22, padding: "22px 18px", color: "#fff", marginBottom: 12, boxShadow: "0 14px 30px rgba(22,15,65,.16)" }}>
                ...
                <div style={{ fontSize: 13, lineHeight: 1.6, opacity: .92 }}>
                  Ya puedes continuar con el Quiz o el Juego interactivo.
                </div>
              </div>
            ...
            <div style={{ background: `linear-gradient(160deg, ${C.secondary} 0%, ${C.secondary} 55%, ${C.primary} 100%)`, padding: "28px 20px 32px", position: "relative", overflow: "hidden" }}>
              ...
              <div style={{ display:"grid", gridTemplateColumns:"repeat(3, minmax(0,1fr))", gap:10 }}>
                {[
                  ...
                  { label:"Recompensa máxima", value:"+120 XP" },
