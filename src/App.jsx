  ...
  if (done) return (
    <div style={appSt}>
      ...
      <div style={{ padding: "30px 18px 40px" }}>
        <div style={{ background: `linear-gradient(160deg, ${C.secondary} 0%, #2A175F 60%, ${C.primary} 100%)`, borderRadius: 26, padding: "28px 20px", textAlign: "center", color: "#fff", boxShadow: "0 18px 40px rgba(22,15,65,.18)", marginBottom: 18 }}>
  ...
  if (screen === "home") return (
    <div style={appSt}>
      ...
      <div style={{ padding: "18px 18px 88px" }}>
        <div style={{ background: `linear-gradient(160deg, ${C.secondary} 0%, #26155E 58%, ${C.primary} 100%)`, borderRadius: 28, padding: "22px 20px", color: "#fff", boxShadow: "0 18px 40px rgba(22,15,65,.18)", marginBottom: 18, position: "relative", overflow: "hidden" }}>
          ...
          <div style={{ position: "relative" }}>
            ...
            <div style={{ background: "rgba(255,255,255,.18)", borderRadius: 999, height: 10, overflow: "hidden" }}>
              <div style={{ height: "100%", borderRadius: 999, background: "linear-gradient(90deg, #fff, #F7D4EA)", width: `${progress}%`, transition: "width 0.7s ease" }} />
            </div>
          </div>
        </div>
      ...
      <div style={appSt}>
        ...
        {gameScreen === "intro" && (
          <div style={{ padding: "0 0 32px" }}>
            <div style={{ background: `linear-gradient(160deg, ${C.secondary} 0%, #2D1B69 55%, #4A1259 100%)`, padding: "28px 20px 32px", position: "relative", overflow: "hidden" }}>
        ...
        {gameScreen === "play" && sc && (
          <div style={{ paddingBottom:32 }}>
            ...
            <div style={{ background:`linear-gradient(160deg, ${C.secondary} 0%, #2D1B69 100%)`, padding:"18px 18px 0", position:"relative", overflow:"hidden" }}>
              {/* Starfield */}
        ...
        {gameScreen === "result" && (() => {
          ...
          return (
            <div style={{ paddingBottom:32 }}>
              <div style={{ background:`linear-gradient(160deg, ${C.secondary} 0%, #2D1B69 60%, #4A1259 100%)`, padding:"28px 20px 36px", textAlign:"center", position:"relative", overflow:"hidden" }}>
