                  ...
                  return (
                    <div key={i} style={{ position:"absolute", left:wp.left, top:wp.top, transform:"translate(-50%,-50%)" }}>
                      <div style={{
                        ...
                        borderRadius:"50%",
                        background: done ? `linear-gradient(135deg,${C.success},${C.success})` : current ? `linear-gradient(135deg,${C.quat},${C.primary})` : "rgba(255,255,255,.15)",
                        border: current ? "3px solid #fff" : done ? `2px solid ${C.success}` : "2px solid rgba(255,255,255,.3)",
