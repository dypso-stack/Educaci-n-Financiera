...
const STORAGE_KEY = "bg_finanzas_taller_state_v3";
...
export default function FinanzasTaller() {
  ...
  }, [xp, completed, completedModules, viewedLessonPages, soundOn]);
  ...
  if (screen === "quizmode") {
    ...
    return <QuizMode xp={xp} setXp={setXp} rewardEnabled={!completedModules.quiz} onBack={() => setScreen("home")} onGoGame={() => { resetGame(); setScreen("game"); }} onGoLearn={() => setScreen("learn")} onGoHome={() => setScreen("home")} onComplete={() => setCompletedModules(m => ({ ...m, quiz: true }))} />;
  }
          ...
          {!isLastLesson || !isLastPage || !finalLessonCompleted ? (
            ...
            <div style={{ marginTop: 18 }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr", gap: 10 }}>
                ...
                <button onClick={() => { resetGame(); setScreen("game"); }} style={{ padding: 15, borderRadius: 14, background: C.bg, border: `1.5px solid ${C.quat}`, color: C.quat, fontSize: 14, fontWeight: 800, cursor: "pointer", fontFamily: "inherit" }}>
                  Ir al juego 🎮
                </button>
                <button onClick={() => setScreen("learn")} style={{ padding: 14, borderRadius: 14, background: C.bgSoft, border: `1px solid ${C.border}`, color: C.textMid, fontSize: 14, fontWeight: 800, cursor: "pointer", fontFamily: "inherit" }}>
                  Ir al inicio de aprendizaje
